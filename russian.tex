...
\end{longtblr}
\end{latexcode}
\captionof{figure}{Вёрстка таблицы с помощью окружения \package{longtblr} (пакет \package{tabularray})}\label{tabularray3}
%\end{figure}%
\bigskip
\bigskip
%\begin{figure}[tp]
{\DefTblrTemplate{conthead-text}{default}{(продолжение)}%
\DefTblrTemplate{caption-sep}{default}{. }%
\begin{tcolorbox}[colback=white,colframe=white,height=7.5cm]%
\begin{multicols}{2}%
\vspace*{-11pt}
\begin{longtblr}[
  label={table1},
...
\end{multicols}%
\end{tcolorbox}
\captionof{figure}{Результат вёрстки таблицы с помощью окружения \package{longtblr} (пакет \package{tabularray})}\label{tabularray4}
}
%\end{figure}
