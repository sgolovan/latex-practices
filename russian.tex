...
\begin{document}
\pdfbookmark[1]{LaTEX в 2020 году}{title}%
\vspace{-\baselineskip}%
\maketitle
...
или \foothref{https://github.com/pgf-tikz/pgf}{PGF/Ti\emph{k}z}),
...
существовал досадный \foothref{https://github.com/reutenauer/polyglossia/issues/24}{баг
...
работает \foothref{https://tex.stackexchange.com/questions/566505/xindy-with-texmaker-and-miktex-on-ubuntu-yield-call-to-xindy-failed-error-code}{не всегда}. Поэтому я потихоньку начинаю смотреть в сторону
...
\newcommand{\mathsamplerus}[1]{%
  ...
  \begin{equation*}
    z(t) \mathrel{∶=} (1−t)^3z_1+3(1−t)^2tz_2+3(1−t)t^2z_3+t^3z_4,\quad 0\le t\le 1.
  \end{equation*}
  Так как $(1−t)^3+3(1−t)^2t+3(1−t)t^2+t^3=(1-t+t)^3=1$, и все слагаемые неотрицательные при $0\le t\le1$, $z(t)$
  ...
  Пусть $f$~--- функция, голоморфная в области $G$ всюду, за исключением изолированного множества особых
...
\clearpage
\subsection{Source Serif Pro \& STIX Two Math}
\setcounter{equation}{0}
\setmainfont{Source Serif Pro}
\setmathfont[version=source,mathrm=sym]{STIX Two Math}
\mathversion{source}
\begin{latexcode}
\setmainfont{Source Serif Pro}
\setmathfont{STIX Two Math}
...
\clearpage
\subsection{PT Astra Serif \& Cambria Math}
\setcounter{equation}{0}
\setmainfont{PT Astra Serif}
\setmathfont[Scale=MatchLowercase,version=astra,mathrm=sym]{Cambria Math}
\mathversion{astra}
\begin{latexcode}
\setmainfont{PT Astra Serif}
...
\clearpage
\subsection{Alegreya Sans \& Fira Math}
\setcounter{equation}{0}
\setmainfont[Numbers=Uppercase]{Alegreya Sans}
\setmathfont[Scale=MatchLowercase,version=alegreya,mathrm=sym]{Fira Math}
\mathversion{alegreya}
\begin{latexcode}
\setmainfont[Numbers=Uppercase]{Alegreya Sans}
\setmathfont[Scale=MatchLowercase]{Fira Math}
\end{latexcode}
\small
\mathsamplerus{alegreya}
...
\clearpage
\subsection{PT Astra Sans \& Fira Math}
\setcounter{equation}{0}
\setmainfont{PT Astra Sans}
\setmathfont[Scale=MatchLowercase,ScaleAgain=1.00001,version=ptastrasans,mathrm=sym]{Fira Math}
\mathversion{ptastrasans}
\begin{latexcode}
\setmainfont{PT Astra Sans}
\setmathfont[Scale=MatchLowercase]{Fira Math}
\end{latexcode}
\small
\mathsamplerus{ptastrasans}

\clearpage
\subsection{Source Sans Pro \& Fira Math}
\setcounter{equation}{0}
\setmainfont{Source Sans Pro}
\setmathfont[Scale=MatchLowercase,ScaleAgain=1.00001,version=sourcesans,mathrm=sym]{Fira Math}
\mathversion{sourcesans}
\begin{latexcode}
\setmainfont{Source Sans Pro}
\setmathfont[Scale=MatchLowercase]{Fira Math}
\end{latexcode}
\small
\mathsamplerus{sourcesans}

\clearpage
\subsection{Arial \& Fira Math}
\setcounter{equation}{0}
\setmainfont{Arial}
\setmathfont[Scale=MatchUppercase,ScaleAgain=1.00001,version=arial,mathrm=sym]{Fira Math}
\mathversion{arial}
\begin{latexcode}
\setmainfont{Arial}
