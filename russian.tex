...
Лиературная, который в бесплатном виде доступен только в формате Type1, то приходится
...
он мне более привычен. Ну и время от времени я все-таки пользуюсь \pdfLaTeX, а там
выбора нет.
...
\clearpage
\subsection{Cyrillic Modern \& Latin Modern Math}
