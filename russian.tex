...
\setcounter{equation}{0}
\setmainfont[Scale=1.15,Numbers=Uppercase]{Alegreya Sans}
\setmathfont[version=alegreya,mathrm=sym]{Fira Math}
...
\setcounter{equation}{0}
\setmainfont[Scale=1.05]{PT Sans}
\setmathfont[version=ptsans,mathrm=sym]{Fira Math}
\mathversion{ptsans}
\begin{latexcode}
\setmainfont[Scale=1.05]{PT Sans}
\setmathfont{Fira Math}
...
\setcounter{equation}{0}
\setmainfont[Scale=1.05]{Source Sans Pro}
\setmathfont[version=sourcesans,mathrm=sym]{Fira Math}
...
\setcounter{equation}{0}
\setmainfont{Arial}
\setmathfont[version=arial,mathrm=sym]{Fira Math}
\mathversion{arial}
\begin{latexcode}
\setmainfont{Arial}
\setmathfont{Fira Math}
