...
Литература по Plain \TeX\ и по \hologo{AmSTeX}:
...
\clearpage
\normalsize
\subsection[Jost 350 \& GFS Neohellenic Math]{Jost 350 \parencite{google-fonts-jost} \& GFS Neohellenic Math \parencite{ctan-gfsneohellenicmath}}
\setcounter{equation}{0}
